...
In Antigravity, Workflows live in the `.agent/workflows/` directory. They act as pre-packaged prompt sequences that guide the agent step-by-step through a complex process.
...
**Save as:** `.agent/workflows/moqui-audit.md`
