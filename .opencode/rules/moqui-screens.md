...
- For complex UI architecture—including **Safe Subscreen Detection** (preventing tab leakage), **Idiomatic Status Chips**, and **Parent Context Clearing**—you MUST consult the approved code snippets in `.opencode/knowledge/moqui-ui-patterns.md`.
- For questions about valid Moqui tags, consult `.opencode/knowledge/moqui_syntax_ref.md`.
...
- Common errors that break screens:
  ...
  - Invalid tag nesting
- See `.opencode/knowledge/moqui-testing.md` section 12 for more details.