...
2. **Knowledge Retrieval:** Read the knowledge at `.opencode/knowledge/moqui-service-patterns.md` and `.opencode/knowledge/moqui-common-patterns.md` to check for architectureal context, existing resolutions
